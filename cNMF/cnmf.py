...
class cNMF():
    ...
    def run_nmf(self,
        ...
        with concurrent.futures.ProcessPoolExecutor(max_workers=total_workers) as executor:
            futures = [executor.submit(self._run_nmf_worker, i) for i in range(len(run_params))]
...
def factorize(cnmf_obj, total_workers=1):
    ...
    Parameters:
        ...
        cnmf_obj: A cNMF object (should already be initialized)
        worker_index: Index of current worker (the first worker should have index 0)
